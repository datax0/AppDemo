...
namespace NiftyAppz.Proto
{
	...
	public static class Theme
	{
		...
		static Lazy<UIImage> login = new Lazy<UIImage> (() => UIImage.FromFile ("Images/login-icon.png"));
			
		public static UIImage Login {
			get { return login.Value; }
		}

		static Lazy<UIImage> register = new Lazy<UIImage> (() => UIImage.FromFile ("Images/signup-icon.png"));

		public static UIImage Register {
		...
		const string BoldFontNameiOS7 = "Avenir-Medium";
